...
<!DOCTYPE html>
  <html lang="fr">
    <head>
      ...
      <title>pluriel noms en -ou</title>      
    ...
    <body>
      <section>
        <div class="row justify-content-center">
          <img class="img-fluid" src="assets/img/pluriel_ou.png" alt="pluriel des noms en -ou">
        </div>
      </section>
      <br/>
      <!-- QUIZZ-->
      <form action="cible_grammaire.php" method="get">
        ...
        for($i=1; $i<=$nombreDeQuestions; $i++){
          ...
          $question = $bdd->query("SELECT question.intitule_question, reponse.intitule_reponse FROM question, reponse WHERE question.id_theme= 28
