...
<html lang="fr">
  <head>
      ...
      <title>cible imparfait auxiliaires</title>      
  ...
  <body>
    <section>
      <div class="row justify-content-center">
        <h2>Imparfait des auxiliaires</h2>
      </div>
      <div class="row justify-content-center">
  ...
  if($numeroQuestion<=5){
    ...
    { 
      ...
      //question suivante
      header( "refresh:2;url=imparfait_aux"); 
    ...
    //CAS 2 **** ESPACE COMMENTAIRE RÉPONSE INCORRECTE
      {
        ...
        <?php
        header( "refresh:2;url=imparfait_aux.php") ?>
        <?php
      }
    ...
    //AU DESSUS DE 6 QUESTIONS
      ...
      <section class="container">
        <div class="row justify-content-center">
          <a href="imparfait_aux.php"><button type="button" class="btn">Rejouer</button></a>
