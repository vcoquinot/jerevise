...
<html lang="fr">
  <head>
      ...
      <title>cible passé composé avec avoir</title>      
  ...
  <body>
    <section>
      <div class="row justify-content-center">
        <h2>Le pasé composé avec avoir</h2>
      </div>
      <div class="row justify-content-center">
        <img class="img-fluid" src="assets/img/passe_compose_avoir.png" alt="conjugaison">
      </div>
    </section>
  ...
  if($numeroQuestion<=5){
    ...
    { 
      ...
      //question suivante
      header( "refresh:2;url=passe_compose_avoir.php"); 
    ...
    //AU DESSUS DE 6 QUESTIONS
      ...
      <section class="container">
        <div class="row justify-content-center">
          <a href="passe_compose_avoir.php"><button type="button" class="btn">Rejouer</button></a>
