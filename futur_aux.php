  ...
  ?>
    ...
    <section id="futur_premier_groupe">
      <div class="row justify-content-center">
        <h2>Le futur des auxiliaires</h2>
      </div>
      <div class="row justify-content-center">
        <img class="img-fluid" src="assets/img/imparfait_aux.png" alt="futur auxiliaires">
      </div>
    </section>
    ...
    <section class="questionnaire">      
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
         ...
         <input type="hidden" name="url" value="futur_aux.php">
        </form>
      </div>
    </section>
