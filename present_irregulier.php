...
<html lang="fr">
  <head>
      ...
      <title>Présent irrégulier</title>      
  ...
  <?php
    ...
    <section>
      <div class="row justify-content-center">
        <h2>Le présent des verbes irréguliers</h2>
      </div>
      <br />
      <div class="row justify-content-center">
        <img class="img-fluid" src="assets/img/futur_irregulier_girl.png" alt="présent irrégulier">
      </div>
    </section>
    ...
    <section class="questionnaire">      
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
         ...
         <input type="hidden" name="url" value="present_irregulier.php">
        </form>
      </div>
    </section>
  </body>
