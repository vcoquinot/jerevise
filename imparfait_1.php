...
<html lang="fr">
  <head>
      ...
      <title>Imparfait er groupe</title>      
  ...
  <?php
    ...
    <section>
      <div class="row justify-content-center">
        <h2>Imparfait 1er groupe</h2>
      </div>
      <br />
      <div class="row justify-content-center">
        <img class="img-fluid" src="assets/img/imparfait1.png" alt="conjugaison">
      </div>
    </section>
    ...
    <section class="questionnaire">      
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <form action="cible_imparfait1.php" method="get">
            <?php
            //recherche alléatoire d'une question
            $questionFutur = $bdd->query("SELECT intitule_question, id_question FROM question WHERE id_matiere = 2 && id_theme = 16 ORDER BY RAND() LIMIT 1");
