...
<html lang="fr">
  <head>
      ...
      <title>Imparfait auxilaires</title>      
  ...
  <?php
    ...
    <section>
      <div class="row justify-content-center">
        <h2>Imparfait des auxilaires</h2>
      </div>
      <br />
      <div class="row justify-content-center">
    ...
    <section class="questionnaire">      
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <form action="cible_imparfait_aux.php" method="get">
            <?php
            //recherche alléatoire d'une question
            $questionFutur = $bdd->query("SELECT intitule_question, id_question FROM question WHERE id_matiere = 2 && id_theme = 17 ORDER BY RAND() LIMIT 1");
