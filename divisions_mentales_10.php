          ...
          <div class="row">            
            ...
            <div class="col-lg-5">
              ...
              <input class="col-lg-2" name="resultatCorrectUn" type="hidden"
               value="<?php echo $resultatCorrectUn= divide($randFirstNumber, $secondNumber); 
              ?>">
            </div>
            <!--Calcul N° deux-->
            <div class="col-lg-5">
              ...
              name="resultatCorrectDeux" value="<?php echo $resultatCorrectDeux= divide($randFirstNumber, $secondNumber); 
              ?>">
            </div>
          </div>
          <!--Calcul N° trois-->
          <div class="row">            
            ...
            <div class="col-lg-5">
              ...
              <input class="col-lg-2" name="resultatCorrectTrois" type="hidden"
               value="<?php echo $resultatCorrectDeux= divide($randFirstNumber, $secondNumber); 
              ?>">
            </div>
            <!--Calcul N° quatre-->
            <div class="col-lg-5">
            ...
            <input class="col-lg-2" type="hidden"
            name="resultatCorrectQuatre" value="<?php echo $resultatCorrectQuatre= divide($randFirstNumber, $secondNumber); 
            ?>">
            </div>
          </div>
