...
<html lang="fr">
  <head>
      ...
      <title>Présent 1er groupe</title>      
  ...
  <?php
    ...
    <section>
      <div class="row justify-content-center">
        <h2>Le présent et ses petits pièges !</h2>
      </div>
      <br />
      <div class="row justify-content-center">
        <img class="img-fluid" src="assets/img/present_radical.png" alt="verbes piège !">
      </div>
    </section>
    ...
    <section class="questionnaire">      
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
         ...
         <input type="hidden" name="url" value="present_piege.php">
        </form>
      </div>
    </section>
  </body>
