...
<html lang="fr">
  <head>
      ...
      <title>cible imparfait 2è groupe</title>      
  ...
  if($numeroQuestion<=5){
    ...
    { 
      ...
      //question suivante
      header( "refresh:2;url=imparfait_2"); 
    ...
    //CAS 2 **** ESPACE COMMENTAIRE RÉPONSE INCORRECTE
      {
        ...
        <?php
        header( "refresh:2;url=imparfait_2.php") ?>
        <?php
      }
    ...
    //AU DESSUS DE 6 QUESTIONS
      ...
      <section class="container">
        <div class="row justify-content-center">
          <a href="imparfait_2.php"><button type="button" class="btn">Rejouer</button></a>
