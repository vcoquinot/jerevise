...
<!-- Bootstrap -->
  ...
  <body>
    <section>
      ...
      <img class="img-fluid" src="assets/img/-1000.png" alt="soustraction de 1000">
      </div>
    </section>
    <br /><br />
    ...
    <form action="cible_calcul_mental.php" method="get">
      ...
      <div class = "col-lg-12">
        <div class="row justify-content-center">
          <input type="submit" value=" Mon score " style="border-color:#F7B710; background-color: #F7B710; color: black; font-weight: bold; font-size:20px;" >
