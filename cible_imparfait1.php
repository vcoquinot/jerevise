...
<html lang="fr">
  <head>
      ...
      <title>cible imparfait 1er groupe</title>      
  ...
  if($numeroQuestion<=5){
    ...
    { 
      ...
      //question suivante
      header( "refresh:2;url=imparfait_1"); 
    ...
    //CAS 2 **** ESPACE COMMENTAIRE RÉPONSE INCORRECTE
      {
        ...
        <?php
        header( "refresh:2;url=imparfait_1.php") ?>
        <?php
      }
    ...
    //AU DESSUS DE 6 QUESTIONS
      ...
      <section class="container">
        <div class="row justify-content-center">
          <a href="imparfait_1.php"><button type="button" class="btn">Rejouer</button></a>
