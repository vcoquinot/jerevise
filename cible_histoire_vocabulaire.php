...
<!-- Bootstrap -->
  ...
  $inputHistoireVocabulaire = $_POST["reponseHistoireVocabulaire"];
    ...
    ?>
      ...
      <div class="row justify-content-center">
          ...
          <div class="col-lg-2 col-md-3 col-6">
            <a href="vocabulaireHistoire.php">
