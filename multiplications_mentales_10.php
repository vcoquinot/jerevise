...
<!-- Bootstrap -->
  ...
  <body>
    <section>
      ...
      <img class="img-fluid" src="assets/img/maths_multiply_10.png" alt="multiplication par 10">
      </div>
    </section>
    <br />
    ...
    <form action="cible_calcul_mental.php" method="get">
        ...
        <div class = "col-lg-12">
          <div class="row">            
            ...
            <div class="col-lg-5">
              ...
              <i class="fa fa-times-circle" style="color:#7b533b"></i> 
              ...
              <input class="col-lg-2" name="resultatCorrectUn" type="hidden"
               value="<?php echo $resultatCorrectUn= multiplication($randFirstNumber, $secondNumber);?>">
            ...
            name="resultatCorrectDeux" value="<?php echo $resultatCorrectDeux= multiplication($randFirstNumber, $secondNumber); 
            ?>">
            </div>
          </div>
          <br /><br />
          ...
          <div class="row">            
            ...
            <div class="col-lg-5">
              ...
              <input class="col-lg-2" name="resultatCorrectTrois" type="hidden"
               value="<?php echo $resultatCorrectDeux= multiplication($randFirstNumber, $secondNumber); 
              ?>">
            </div>
            <!--Calcul N° quatre-->
            <div class="col-lg-5">
            ...
            <input class="col-lg-2" type="hidden"
            name="resultatCorrectQuatre" value="<?php echo $resultatCorrectQuatre= multiplication($randFirstNumber, $secondNumber); 
            ?>">
            </div>
          </div>
          <br /><br />
      ...
      <div class = "col-lg-12">
        <div class="row justify-content-center">
          <input type="submit" value=" Mon score " style="border-color:#7b533b; background-color: #7b533b; color: white; font-weight: bold; font-size:20px;" >
